...
public class OptionalDependentQueryGaussDBTest : OptionalDependentQueryTestBase<
    OptionalDependentQueryGaussDBTest.OptionalDependentQueryGaussDBFixture>
{
    public OptionalDependentQueryGaussDBTest(OptionalDependentQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class OptionalDependentQueryGaussDBFixture : OptionalDependentQueryFixtureBase
    {
