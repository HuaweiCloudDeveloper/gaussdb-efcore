...
[RequiresPostgis]
public class SpatialQueryGaussDBGeometryTest
    : SpatialQueryRelationalTestBase<SpatialQueryGaussDBGeometryTest.SpatialQueryGaussDBGeometryFixture>
{
    // ReSharper disable once UnusedParameter.Local
    public SpatialQueryGaussDBGeometryTest(SpatialQueryGaussDBGeometryFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class SpatialQueryGaussDBGeometryFixture : SpatialQueryGaussDBFixture
    {
        public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
        {
            var optionsBuilder = base.AddOptions(builder);
            new GaussDBDbContextOptionsBuilder(optionsBuilder).UseNetTopologySuite();
