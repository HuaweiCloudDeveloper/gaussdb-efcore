...
public class PrecompiledSqlPregenerationQueryGaussDBTest(
    PrecompiledSqlPregenerationQueryGaussDBTest.PrecompiledSqlPregenerationQueryGaussDBFixture fixture,
    ITestOutputHelper testOutputHelper)
    : PrecompiledSqlPregenerationQueryRelationalTestBase(fixture, testOutputHelper),
        IClassFixture<PrecompiledSqlPregenerationQueryGaussDBTest.PrecompiledSqlPregenerationQueryGaussDBFixture>
{
...
""");
    ...
    public class PrecompiledSqlPregenerationQueryGaussDBFixture : PrecompiledSqlPregenerationQueryRelationalFixture
    {
