...
public class Ef6GroupByGaussDBTest : Ef6GroupByTestBase<Ef6GroupByGaussDBTest.Ef6GroupByGaussDBFixture>
{
    public Ef6GroupByGaussDBTest(Ef6GroupByGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class Ef6GroupByGaussDBFixture : Ef6GroupByFixtureBase, ITestSqlLoggerFactory
    {
