...
public class CharacterQueryGaussDBTest : IClassFixture<CharacterQueryGaussDBTest.CharacterQueryGaussDBFixture>
{
    private CharacterQueryGaussDBFixture Fixture { get; }

    // ReSharper disable once UnusedParameter.Local
    public CharacterQueryGaussDBTest(CharacterQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    {
        Fixture = fixture;
    ...
    /// </summary>
    public class CharacterQueryGaussDBFixture : SharedStoreFixtureBase<CharacterContext>
    {
        protected override string StoreName
            => "CharacterQueryGaussDBTest";
