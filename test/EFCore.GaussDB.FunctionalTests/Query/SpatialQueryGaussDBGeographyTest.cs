...
[RequiresPostgis]
public class SpatialQueryGaussDBGeographyTest
    : SpatialQueryRelationalTestBase<SpatialQueryGaussDBGeographyTest.SpatialQueryGaussDBGeographyFixture>
{
    // ReSharper disable once UnusedParameter.Local
    public SpatialQueryGaussDBGeographyTest(SpatialQueryGaussDBGeographyFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class SpatialQueryGaussDBGeographyFixture : SpatialQueryGaussDBFixture
    {
        ...
        public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
        {
            ...
            new GaussDBDbContextOptionsBuilder(optionsBuilder).UseNetTopologySuite(null, null, Ordinates.None, true);
