...
public class AdHocAdvancedMappingsQueryGaussDBTest(NonSharedFixture fixture)
    : AdHocAdvancedMappingsQueryRelationalTestBase(fixture)
{
    protected override ITestStoreFactory TestStoreFactory
        => GaussDBTestStoreFactory.Instance;

    // Cannot write DateTime with Kind=Unspecified to GaussDB type 'timestamp with time zone', only UTC is supported.
    ...
    // Cannot write DateTimeOffset with Offset=10:00:00 to GaussDB type 'timestamp with time zone', only offset 0 (UTC) is supported.
