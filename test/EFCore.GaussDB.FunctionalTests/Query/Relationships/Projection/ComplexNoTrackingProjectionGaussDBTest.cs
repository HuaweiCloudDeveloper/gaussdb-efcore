...
public class ComplexNoTrackingProjectionGaussDBTest
    : ComplexNoTrackingProjectionRelationalTestBase<ComplexRelationshipsGaussDBFixture>
{
    public ComplexNoTrackingProjectionGaussDBTest(ComplexRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
