...
public class OwnedJsonReferenceProjectionSqlServerTest
    : OwnedJsonReferenceProjectionRelationalTestBase<OwnedJsonRelationshipsGaussDBFixture>
{
    public OwnedJsonReferenceProjectionSqlServerTest(OwnedJsonRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
