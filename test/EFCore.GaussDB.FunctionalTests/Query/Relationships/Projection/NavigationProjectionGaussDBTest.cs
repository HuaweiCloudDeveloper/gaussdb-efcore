...
public class NavigationProjectionGaussDBTest
    : NavigationProjectionRelationalTestBase<NavigationRelationshipsGaussDBFixture>
{
    public NavigationProjectionGaussDBTest(NavigationRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
