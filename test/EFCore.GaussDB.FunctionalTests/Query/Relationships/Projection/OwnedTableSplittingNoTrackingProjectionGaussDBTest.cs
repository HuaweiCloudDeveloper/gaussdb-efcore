...
public class OwnedTableSplittingNoTrackingProjectionGaussDBTest
    : OwnedTableSplittingNoTrackingProjectionRelationalTestBase<OwnedTableSplittingRelationshipsGaussDBFixture>
{
    public OwnedTableSplittingNoTrackingProjectionGaussDBTest(OwnedTableSplittingRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
