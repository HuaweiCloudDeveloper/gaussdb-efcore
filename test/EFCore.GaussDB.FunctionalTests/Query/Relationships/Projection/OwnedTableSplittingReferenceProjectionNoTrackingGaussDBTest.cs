...
public class OwnedTableSplittingReferenceProjectionNoTrackingGaussDBTest
    : OwnedTableSplittingReferenceProjectionNoTrackingRelationalTestBase<OwnedTableSplittingRelationshipsGaussDBFixture>
{
    public OwnedTableSplittingReferenceProjectionNoTrackingGaussDBTest(OwnedTableSplittingRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
