...
public class NavigationReferenceNoTrackingProjectionSqlServerTest
    : NavigationReferenceNoTrackingProjectionRelationalTestBase<NavigationRelationshipsGaussDBFixture>
{
    public NavigationReferenceNoTrackingProjectionSqlServerTest(NavigationRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
