...
public class OwnedJsonProjectionSqlServerTest
    : OwnedJsonProjectionRelationalTestBase<OwnedJsonRelationshipsGaussDBFixture>
{
    public OwnedJsonProjectionSqlServerTest(OwnedJsonRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
