...
public class OwnedJsonNoTrackingProjectionGaussDBTest
    : OwnedJsonNoTrackingProjectionRelationalTestBase<OwnedJsonRelationshipsGaussDBFixture>
{
    public OwnedJsonNoTrackingProjectionGaussDBTest(OwnedJsonRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
