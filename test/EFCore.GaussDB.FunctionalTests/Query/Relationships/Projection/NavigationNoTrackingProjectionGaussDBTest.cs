...
public class NavigationNoTrackingProjectionGaussDBTest
    : NavigationNoTrackingProjectionRelationalTestBase<NavigationRelationshipsGaussDBFixture>
{
    public NavigationNoTrackingProjectionGaussDBTest(NavigationRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
