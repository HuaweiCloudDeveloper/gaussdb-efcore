...
public class OwnedProjectionGaussDBTest
    : OwnedProjectionRelationalTestBase<OwnedRelationshipsGaussDBFixture>
{
    public OwnedProjectionGaussDBTest(OwnedRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
