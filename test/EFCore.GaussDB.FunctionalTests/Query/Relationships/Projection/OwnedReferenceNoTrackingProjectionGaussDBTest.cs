...
public class OwnedReferenceNoTrackingProjectionGaussDBTest
    : OwnedReferenceNoTrackingProjectionRelationalTestBase<OwnedRelationshipsGaussDBFixture>
{
    public OwnedReferenceNoTrackingProjectionGaussDBTest(OwnedRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
