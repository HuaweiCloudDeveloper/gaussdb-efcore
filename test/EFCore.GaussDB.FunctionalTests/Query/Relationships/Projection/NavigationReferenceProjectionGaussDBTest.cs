...
public class NavigationReferenceProjectionGaussDBTest
    : NavigationReferenceProjectionRelationalTestBase<NavigationRelationshipsGaussDBFixture>
{
    public NavigationReferenceProjectionGaussDBTest(NavigationRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
