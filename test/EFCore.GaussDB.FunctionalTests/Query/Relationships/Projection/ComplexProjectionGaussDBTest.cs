...
public class ComplexProjectionGaussDBTest
    : ComplexProjectionRelationalTestBase<ComplexRelationshipsGaussDBFixture>
{
    public ComplexProjectionGaussDBTest(ComplexRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
