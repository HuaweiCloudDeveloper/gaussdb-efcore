...
public class OwnedReferenceProjectionGaussDBTest
    : OwnedReferenceProjectionRelationalTestBase<OwnedRelationshipsGaussDBFixture>
{
    public OwnedReferenceProjectionGaussDBTest(OwnedRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
