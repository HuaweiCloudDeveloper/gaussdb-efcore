...
public class OwnedNoTrackingProjectionGaussDBTest
    : OwnedNoTrackingProjectionRelationalTestBase<OwnedRelationshipsGaussDBFixture>
{
    public OwnedNoTrackingProjectionGaussDBTest(OwnedRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
