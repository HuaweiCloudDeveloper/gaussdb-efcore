...
public class NavigationIncludeGaussDBTest
    : NavigationIncludeRelationalTestBase<NavigationRelationshipsGaussDBFixture>
{
    public NavigationIncludeGaussDBTest(NavigationRelationshipsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
