...
[RequiresPostgis]
public class SpatialGaussDBTest(SpatialGaussDBFixture fixture) : SpatialTestBase<SpatialGaussDBFixture>(fixture)
{
    protected override void UseTransaction(DatabaseFacade facade, IDbContextTransaction transaction)
        => facade.UseTransaction(transaction.GetDbTransaction());

    // This test requires DbConnection to be used with the test store, but SpatialGaussDBFixture must set useConnectionString to true
