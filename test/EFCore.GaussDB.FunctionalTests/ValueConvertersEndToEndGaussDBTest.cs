...
public class ValueConvertersEndToEndGaussDBTest(ValueConvertersEndToEndGaussDBTest.ValueConvertersEndToEndGaussDBFixture fixture)
    : ValueConvertersEndToEndTestBase<ValueConvertersEndToEndGaussDBTest.ValueConvertersEndToEndGaussDBFixture>(fixture)
{
    ...
    public class ValueConvertersEndToEndGaussDBFixture : ValueConvertersEndToEndFixtureBase
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            // Add some GaussDB-specific value conversion scenarios
