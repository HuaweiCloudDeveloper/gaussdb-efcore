...
public class LazyLoadProxyGaussDBTest : LazyLoadProxyRelationalTestBase<LazyLoadProxyGaussDBTest.LoadGaussDBFixture>
{
    public LazyLoadProxyGaussDBTest(LoadGaussDBFixture fixture)
        : base(fixture)
    {
...
""";
    ...
    public class LoadGaussDBFixture : LoadRelationalFixtureBase
    {
