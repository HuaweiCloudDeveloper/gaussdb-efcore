...
public class StoreGeneratedGaussDBTest(StoreGeneratedGaussDBTest.StoreGeneratedGaussDBFixture fixture)
    : StoreGeneratedTestBase<StoreGeneratedGaussDBTest.StoreGeneratedGaussDBFixture>(fixture)
{
    protected override void UseTransaction(DatabaseFacade facade, IDbContextTransaction transaction)
        => facade.UseTransaction(transaction.GetDbTransaction());

    public class StoreGeneratedGaussDBFixture : StoreGeneratedFixtureBase
    {
