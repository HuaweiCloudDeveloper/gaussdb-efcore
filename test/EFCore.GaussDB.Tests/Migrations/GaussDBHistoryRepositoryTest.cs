...
public class GaussDBHistoryRepositoryTest
{
    [ConditionalFact]
    ...
    private static IHistoryRepository CreateHistoryRepository(string schema = null)
        => new TestDbContext(
                new DbContextOptionsBuilder()
                    .UseInternalServiceProvider(GaussDBTestHelpers.Instance.CreateServiceProvider())
                    .UseGaussDB(
                        new GaussDBConnection("Host=localhost;Database=DummyDatabase"),
