...
/// <summary>
///     The type mapping for GaussDB range types.
/// </summary>
/// <remarks>
...
public class GaussDBRangeTypeMapping : GaussDBTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </remarks>
    public virtual GaussDBRangeTypeMapping Clone(GaussDBDbType npgsqlDbType, RelationalTypeMapping subtypeTypeMapping)
