...
public static class GaussDBModelExtensions
{
    ...
    public static GaussDBExtension GetOrAddPostgresExtension(
        ...
        string name,
        string? version)
        => GaussDBExtension.GetOrAddPostgresExtension(model, schema, name, version);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static IReadOnlyList<GaussDBExtension> GetPostgresExtensions(this IReadOnlyModel model)
        => GaussDBExtension.GetPostgresExtensions(model).ToArray();
    ...
    public static GaussDBEnum GetOrAddPostgresEnum(
        ...
        string name,
        string[] labels)
        => GaussDBEnum.GetOrAddPostgresEnum(model, schema, name, labels);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static IReadOnlyList<GaussDBEnum> GetPostgresEnums(this IReadOnlyModel model)
        => GaussDBEnum.GetPostgresEnums(model).ToArray();
    ...
    public static GaussDBRange GetOrAddPostgresRange(
        ...
        => GaussDBRange.GetOrAddPostgresRange(
            model,
            schema,
            name,
            subtype,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static IReadOnlyList<GaussDBRange> PostgresRanges(this IReadOnlyModel model)
        => GaussDBRange.GetPostgresRanges(model).ToArray();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static GaussDBCollation GetOrAddCollation(
        this IMutableModel model,
        string? schema,
        string name,
        string lcCollate,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static IReadOnlyList<GaussDBCollation> GetCollations(this IReadOnlyModel model)
        => GaussDBCollation.GetCollations(model).ToArray();
