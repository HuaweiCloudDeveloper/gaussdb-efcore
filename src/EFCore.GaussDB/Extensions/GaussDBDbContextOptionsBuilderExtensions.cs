...
///     used to configure a <see cref="DbContext" /> to context to a GaussDB database with GaussDB.
/// </summary>
public static class GaussDBDbContextOptionsBuilderExtensions
{
    /// <summary>
    ///     <para>
    ///         Configures the context to connect to a GaussDB server with GaussDB, but without initially setting any
    ...
    /// <param name="npgsqlOptionsAction">An optional action to allow additional GaussDB-specific configuration.</param>
    /// <returns>The options builder so that further configuration can be chained.</returns>
    public static DbContextOptionsBuilder UseGaussDB(
        this DbContextOptionsBuilder optionsBuilder,
        Action<GaussDBDbContextOptionsBuilder>? npgsqlOptionsAction = null)
    {
        ...
        npgsqlOptionsAction?.Invoke(new GaussDBDbContextOptionsBuilder(optionsBuilder));

        return optionsBuilder;
    }

    /// <summary>
    ///     Configures the context to connect to a GaussDB database with GaussDB.
    /// </summary>
    ...
    public static DbContextOptionsBuilder UseGaussDB(
        ...
        Action<GaussDBDbContextOptionsBuilder>? npgsqlOptionsAction = null)
        => UseGaussDB(optionsBuilder, connection, contextOwnsConnection: false, npgsqlOptionsAction);
    ...
    /// <param name="optionsBuilder">A builder for setting options on the context.</param>
    /// <param name="connectionString">The connection string of the database to connect to.</param>
    /// <param name="npgsqlOptionsAction">An optional action to allow additional GaussDB-configuration.</param>
    /// <returns>
    ///     The options builder so that further configuration can be chained.
    /// </returns>
    public static DbContextOptionsBuilder<TContext> UseGaussDB<TContext>(
