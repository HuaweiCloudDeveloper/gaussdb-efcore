...
public static class GaussDBModelBuilderExtensions
{
    ...
    public static bool CanSetPostgresExtension(
        ...
        bool fromDataAnnotation = false)
    {
        var annotationName = GaussDBExtension.BuildAnnotationName(schema, name);
...
#pragma warning restore CS0618
    ...
    // See: https://github.com/npgsql/npgsql/blob/dev/src/GaussDB/TypeMapping/TypeMapperBase.cs#L132-L138
    ...
    // See: https://github.com/npgsql/npgsql/blob/dev/src/GaussDB/TypeHandlers/EnumHandler.cs#L118-L129
