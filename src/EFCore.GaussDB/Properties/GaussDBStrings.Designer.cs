...
namespace HuaweiCloud.EntityFrameworkCore.GaussDB.Internal
{
    ...
    public static class GaussDBStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("HuaweiCloud.EntityFrameworkCore.GaussDB.Properties.GaussDBStrings", typeof(GaussDBStrings).Assembly);
        ...
        /// <summary>
        ///     The EF Core 7.0 JSON support isn't currently supported by the GaussDB provider. To map to JSON, see https://www.npgsql.org/efcore/mapping/json.html.
        /// </summary>
...
namespace HuaweiCloud.EntityFrameworkCore.GaussDB.Internal
{
    ...
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("HuaweiCloud.EntityFrameworkCore.GaussDB.Properties.GaussDBStrings", typeof(GaussDBResources).Assembly);
