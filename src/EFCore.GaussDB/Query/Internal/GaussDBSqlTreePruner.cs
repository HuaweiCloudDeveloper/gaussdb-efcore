...
using ColumnInfo = HuaweiCloud.EntityFrameworkCore.GaussDB.Query.Expressions.Internal.GaussDBTableValuedFunctionExpression.ColumnInfo;
...
public class GaussDBSqlTreePruner  : SqlTreePruner
{
    ...
    protected override Expression VisitExtension(Expression node)
    {
        switch (node)
        {
            case GaussDBTableValuedFunctionExpression { ColumnInfos: IReadOnlyList<ColumnInfo> columnInfos } tvf:
