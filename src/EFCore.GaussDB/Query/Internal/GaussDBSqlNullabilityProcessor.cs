...
public class GaussDBSqlNullabilityProcessor : SqlNullabilityProcessor
{
        ...
        out bool nullable)
    {
        ...
        {
            {
                ...
                Left: GaussDBRowValueExpression leftRowValue,
                Right: GaussDBRowValueExpression rightRowValue
            }
        ...
        SqlExpression VisitRowValueComparison(
            ...
            GaussDBRowValueExpression leftRowValue,
            GaussDBRowValueExpression rightRowValue,
            out bool nullable)
        {
                ...
                return visitedLeftValues is null && visitedRightValues is null
                    ...
                    : _sqlExpressionFactory.MakeBinary(
                        ...
                        visitedLeftValues is null
                            ? leftRowValue
                            : new GaussDBRowValueExpression(visitedLeftValues, leftRowValue.Type, leftRowValue.TypeMapping),
                        visitedRightValues is null
                            ? rightRowValue
                            : new GaussDBRowValueExpression(visitedRightValues, leftRowValue.Type, leftRowValue.TypeMapping),
                        typeMapping: null,
            ...
            var unexpandedExpression = visitedLeftValues.Count is 1
                ...
                : _sqlExpressionFactory.MakeBinary(
                    operatorType,
                    new GaussDBRowValueExpression(visitedLeftValues, leftRowValue.Type, leftRowValue.TypeMapping),
                    new GaussDBRowValueExpression(visitedRightValues, rightRowValue.Type, rightRowValue.TypeMapping),
                    typeMapping: null)!;
    ...
    protected override SqlExpression VisitCustomSqlExpression(
        ...
        {
            GaussDBAnyExpression e => VisitAny(e, allowOptimizedExpansion, out nullable),
            GaussDBAllExpression e => VisitAll(e, allowOptimizedExpansion, out nullable),
            GaussDBArrayIndexExpression e => VisitArrayIndex(e, allowOptimizedExpansion, out nullable),
            GaussDBArraySliceExpression e => VisitArraySlice(e, allowOptimizedExpansion, out nullable),
            GaussDBBinaryExpression e => VisitPostgresBinary(e, allowOptimizedExpansion, out nullable),
            GaussDBILikeExpression e => VisitILike(e, allowOptimizedExpansion, out nullable),
            GaussDBJsonTraversalExpression e => VisitJsonTraversal(e, allowOptimizedExpansion, out nullable),
            GaussDBNewArrayExpression e => VisitNewArray(e, allowOptimizedExpansion, out nullable),
            GaussDBRegexMatchExpression e => VisitRegexMatch(e, allowOptimizedExpansion, out nullable),
            GaussDBRowValueExpression e => VisitRowValueExpression(e, allowOptimizedExpansion, out nullable),
            GaussDBUnknownBinaryExpression e => VisitUnknownBinary(e, allowOptimizedExpansion, out nullable),
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual SqlExpression VisitAny(GaussDBAnyExpression anyExpression, bool allowOptimizedExpansion, out bool nullable)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual SqlExpression VisitAll(GaussDBAllExpression allExpression, bool allowOptimizedExpansion, out bool nullable)
    {
    ...
    protected virtual SqlExpression VisitArrayIndex(
        GaussDBArrayIndexExpression arrayIndexExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
    ...
    protected virtual SqlExpression VisitArraySlice(
        GaussDBArraySliceExpression arraySliceExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
    ...
    protected virtual SqlExpression VisitPostgresBinary(
        GaussDBBinaryExpression binaryExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
        ...
        nullable = binaryExpression.OperatorType switch
        {
            ...
            GaussDBExpressionType.LTreeFirstAncestor => true,
            GaussDBExpressionType.LTreeFirstDescendent => true,
            GaussDBExpressionType.LTreeFirstMatches => true,
        ...
        out bool nullable)
    {
        ...
        if (sqlFunctionExpression.IsBuiltIn
            ...
            && coalesceExpression.Arguments[0] is GaussDBFunctionExpression wrappedFunctionExpression)
        {
        ...
        return visitedBase is GaussDBFunctionExpression pgFunctionExpression
            ? VisitPostgresFunctionComponents(pgFunctionExpression)
            : visitedBase;

        GaussDBFunctionExpression VisitPostgresFunctionComponents(GaussDBFunctionExpression pgFunctionExpression)
        {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual SqlExpression VisitILike(GaussDBILikeExpression iLikeExpression, bool allowOptimizedExpansion, out bool nullable)
    {
    ...
    protected virtual SqlExpression VisitNewArray(
        GaussDBNewArrayExpression newArrayExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
        ...
        return newInitializers is null
            ? newArrayExpression
            : new GaussDBNewArrayExpression(newInitializers, newArrayExpression.Type, newArrayExpression.TypeMapping);
    }
    ...
    protected virtual SqlExpression VisitJsonTraversal(
        GaussDBJsonTraversalExpression jsonTraversalExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
    ...
    protected virtual SqlExpression VisitRowValueExpression(
        GaussDBRowValueExpression rowValueExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
    ...
    /// <summary>
    ///     Visits a <see cref="GaussDBUnknownBinaryExpression" /> and computes its nullability.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="unknownBinaryExpression">A <see cref="GaussDBUnknownBinaryExpression" /> expression to visit.</param>
    ...
    protected virtual SqlExpression VisitUnknownBinary(
        GaussDBUnknownBinaryExpression unknownBinaryExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
