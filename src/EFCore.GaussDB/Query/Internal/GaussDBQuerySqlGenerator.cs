...
public class GaussDBQuerySqlGenerator : QuerySqlGenerator
{
    ...
    protected override Expression VisitExtension(Expression extensionExpression)
        ...
        {
            GaussDBAllExpression e => VisitArrayAll(e),
            GaussDBAnyExpression e => VisitArrayAny(e),
            GaussDBArrayIndexExpression e => VisitArrayIndex(e),
            GaussDBArraySliceExpression e => VisitArraySlice(e),
            GaussDBBinaryExpression e => VisitPgBinary(e),
            GaussDBDeleteExpression e => VisitPgDelete(e),
            GaussDBFunctionExpression e => VisitPgFunction(e),
            GaussDBILikeExpression e => VisitILike(e),
            GaussDBJsonTraversalExpression e => VisitJsonPathTraversal(e),
            GaussDBNewArrayExpression e => VisitNewArray(e),
            GaussDBRegexMatchExpression e => VisitRegexMatch(e),
            GaussDBRowValueExpression e => VisitRowValue(e),
            GaussDBUnknownBinaryExpression e => VisitUnknownBinary(e),
            GaussDBTableValuedFunctionExpression e => VisitPgTableValuedFunctionExpression(e),
    ...
    protected override void GenerateRootCommand(Expression queryExpression)
    {
        ...
        {
            case GaussDBDeleteExpression postgresDeleteExpression:
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitPgDelete(GaussDBDeleteExpression pgDeleteExpression)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitNewArray(GaussDBNewArrayExpression pgNewArrayExpression)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitPgBinary(GaussDBBinaryExpression binaryExpression)
    {
    ...
    protected override Expression VisitSqlUnary(SqlUnaryExpression sqlUnaryExpression)
    {
        ...
        switch (sqlUnaryExpression.OperatorType)
        {
                ...
                when sqlUnaryExpression.Type == typeof(bool):
            {
                switch (sqlUnaryExpression.Operand)
                {
                    case GaussDBRegexMatchExpression regexMatch:
                        VisitRegexMatch(regexMatch, negated: true);
                        return sqlUnaryExpression;

                    case GaussDBILikeExpression iLike:
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitArrayAll(GaussDBAllExpression expression)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitArrayAny(GaussDBAnyExpression expression)
    {
        Visit(expression.Item);
    ...
    /// </summary>
    protected virtual Expression VisitArrayIndex(GaussDBArrayIndexExpression expression)
    {
    ...
    /// </summary>
    protected virtual Expression VisitArraySlice(GaussDBArraySliceExpression expression)
    {
        var requiresParentheses = RequiresParentheses(expression, expression.Array);
    ...
    /// </remarks>
    protected virtual Expression VisitRegexMatch(GaussDBRegexMatchExpression expression, bool negated = false)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitRowValue(GaussDBRowValueExpression rowValueExpression)
    {
        Sql.Append("(");
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitILike(GaussDBILikeExpression likeExpression, bool negated = false)
    {
    ...
    /// <summary>
    ///     Visits the children of an <see cref="GaussDBJsonTraversalExpression" />.
    /// </summary>
    /// <param name="expression">The expression.</param>
    /// <returns>
    ///     An <see cref="Expression" />.
    /// </returns>
    protected virtual Expression VisitJsonPathTraversal(GaussDBJsonTraversalExpression expression)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual Expression VisitPgTableValuedFunctionExpression(GaussDBTableValuedFunctionExpression tableValuedFunctionExpression)
    {
        ...
        void GenerateColumnDefinition()
        {
            ...
            void GenerateColumnInfo(GaussDBTableValuedFunctionExpression.ColumnInfo columnInfo)
            {
    ...
    /// <summary>
    ///     Visits the children of a <see cref="GaussDBUnknownBinaryExpression" />.
    /// </summary>
    /// <param name="unknownBinaryExpression">The expression.</param>
    /// <returns>
    ///     An <see cref="Expression" />.
    /// </returns>
    protected virtual Expression VisitUnknownBinary(GaussDBUnknownBinaryExpression unknownBinaryExpression)
    {
    ...
    /// <summary>
    ///     Visits the children of a <see cref="GaussDBFunctionExpression" />.
    /// </summary>
    /// <param name="e">The expression.</param>
    /// <returns>
    ///     An <see cref="Expression" />.
    /// </returns>
    protected virtual Expression VisitPgFunction(GaussDBFunctionExpression e)
    {
    ...
    protected override bool RequiresParentheses(SqlExpression outerExpression, SqlExpression innerExpression)
    {
        switch (innerExpression)
        {
            ...
            case GaussDBBinaryExpression innerBinary:
            {
                    ...
                    && TryGetOperatorInfo(innerExpression, out var innerPrecedence, out _))
                {
                    return outerPrecedence.CompareTo(innerPrecedence) switch
                    {
                        ...
                        _ => outerExpression is not GaussDBBinaryExpression outerBinary
            ...
            case GaussDBUnknownBinaryExpression:
                return true;
    ...
    protected override bool TryGetOperatorInfo(SqlExpression expression, out int precedence, out bool isAssociative)
    {
        ...
        (precedence, isAssociative) = expression switch
        {
            ...
            GaussDBBinaryExpression => (1000, false),

            CollateExpression => (1000, false),
            AtTimeZoneExpression => (1100, false),
            InExpression => (900, false),
            GaussDBJsonTraversalExpression => (1000, false),
            GaussDBArrayIndexExpression => (1500, false),
            GaussDBAllExpression or GaussDBAnyExpression => (800, false),
            LikeExpression or GaussDBILikeExpression or GaussDBRegexMatchExpression => (900, false),
