...
/// <summary>
///     Converts the relational <see cref="DeleteExpression" /> into a PG-specific <see cref="GaussDBDeleteExpression" />, which
...
public class GaussDBDeleteConvertingExpressionVisitor : ExpressionVisitor
{
    ...
    protected virtual Expression VisitDelete(DeleteExpression deleteExpression)
    {
        ...
        return new GaussDBDeleteExpression(deleteExpression.Table, fromItems, predicate, deleteExpression.Tags);
    }
}
