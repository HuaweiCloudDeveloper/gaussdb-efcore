...
/// </remarks>
public class GaussDBRegexTranslator : IMethodCallTranslator
{
    ...
    private GaussDBRegexMatchExpression TranslateIsMatch(IReadOnlyList<SqlExpression> arguments, RegexOptions regexOptions = RegexOptions.None)
