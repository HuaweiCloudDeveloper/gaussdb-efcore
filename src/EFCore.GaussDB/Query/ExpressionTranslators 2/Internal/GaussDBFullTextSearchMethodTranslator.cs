        ...
        if (method.DeclaringType == typeof(GaussDBFullTextSearchLinqExtensions))
        {
            ...
            return method.Name switch
            {
                ...
                nameof(GaussDBFullTextSearchLinqExtensions.And)
                    => _sqlExpressionFactory.MakePostgresBinary(GaussDBExpressionType.TextSearchAnd, arguments[0], arguments[1]),
                nameof(GaussDBFullTextSearchLinqExtensions.Or)
                    => _sqlExpressionFactory.MakePostgresBinary(GaussDBExpressionType.TextSearchOr, arguments[0], arguments[1]),
