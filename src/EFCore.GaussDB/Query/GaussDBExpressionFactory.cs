...
namespace HuaweiCloud.EntityFrameworkCore.GaussDB.Query;

/// <inheritdoc />
public class GaussDBExpressionFactory : SqlExpressionFactory
{
    ...
    /// <summary>
    ///     Creates a new instance of the <see cref="GaussDBExpressionFactory" /> class.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this class.</param>
    public GaussDBExpressionFactory(SqlExpressionFactoryDependencies dependencies)
        : base(dependencies)
    {
    ...
    /// <summary>
    ///     Creates a new <see cref="GaussDBRegexMatchExpression" />, corresponding to the GaussDB-specific <c>~</c> operator.
    /// </summary>
    public virtual GaussDBRegexMatchExpression RegexMatch(
        SqlExpression match,
        SqlExpression pattern,
        RegexOptions options)
        => (GaussDBRegexMatchExpression)ApplyDefaultTypeMapping(new GaussDBRegexMatchExpression(match, pattern, options, null));

    /// <summary>
    ///     Creates a new <see cref="GaussDBAnyExpression" />, corresponding to the GaussDB-specific <c>= ANY</c> operator.
    /// </summary>
    public virtual GaussDBAnyExpression Any(
        SqlExpression item,
        SqlExpression array,
        PgAnyOperatorType operatorType)
        => (GaussDBAnyExpression)ApplyDefaultTypeMapping(new GaussDBAnyExpression(item, array, operatorType, null));

    /// <summary>
    ///     Creates a new <see cref="GaussDBAllExpression" />, corresponding to the GaussDB-specific <c>LIKE ALL</c> operator.
    /// </summary>
    public virtual GaussDBAllExpression All(
        SqlExpression item,
        SqlExpression array,
        PgAllOperatorType operatorType)
        => (GaussDBAllExpression)ApplyDefaultTypeMapping(new GaussDBAllExpression(item, array, operatorType, null));

    /// <summary>
    ///     Creates a new <see cref="GaussDBArrayIndexExpression" />, corresponding to the GaussDB-specific array subscripting operator.
    /// </summary>
    public virtual GaussDBArrayIndexExpression ArrayIndex(
        SqlExpression array,
        SqlExpression index,
        bool nullable,
        RelationalTypeMapping? typeMapping = null)
    {
        ...
        return (GaussDBArrayIndexExpression)ApplyTypeMapping(
            new GaussDBArrayIndexExpression(array, index, nullable, elementType, typeMapping: null),
            typeMapping);
    }
    ...
    ///     Creates a new <see cref="GaussDBArrayIndexExpression" />, corresponding to the GaussDB-specific array subscripting operator.
    /// </summary>
    public virtual GaussDBArraySliceExpression ArraySlice(
        SqlExpression array,
        SqlExpression? lowerBound,
        SqlExpression? upperBound,
        bool nullable,
        RelationalTypeMapping? typeMapping = null)
        => (GaussDBArraySliceExpression)ApplyTypeMapping(
            new GaussDBArraySliceExpression(array, lowerBound, upperBound, nullable, array.Type, typeMapping: null),
            typeMapping);
    ...
    ///     (<c>ILIKE</c>).
    /// </summary>
    public virtual GaussDBILikeExpression ILike(
        SqlExpression match,
        SqlExpression pattern,
        SqlExpression? escapeChar = null)
        => (GaussDBILikeExpression)ApplyDefaultTypeMapping(new GaussDBILikeExpression(match, pattern, escapeChar, null));

    /// <summary>
    ///     Creates a new <see cref="GaussDBJsonTraversalExpression" />, for traversing inside a JSON document.
    /// </summary>
    public virtual GaussDBJsonTraversalExpression JsonTraversal(
    ...
    /// <summary>
    ///     Constructs either a <see cref="GaussDBNewArrayExpression" />, or, if all provided expressions are constants, a single
    ...
    /// <summary>
    ///     Creates a new <see cref="GaussDBNewArrayExpression" />, for creating a new GaussDB array.
    /// </summary>
    public virtual GaussDBNewArrayExpression NewArray(
        IReadOnlyList<SqlExpression> expressions,
        Type type,
        RelationalTypeMapping? typeMapping = null)
        => (GaussDBNewArrayExpression)ApplyTypeMapping(new GaussDBNewArrayExpression(expressions, type, typeMapping), typeMapping);
    ...
    /// <summary>
    ///     Creates a new <see cref="GaussDBBinaryExpression" /> with the given arguments.
    /// </summary>
    ...
    /// <returns>A <see cref="GaussDBBinaryExpression" /> with the given arguments.</returns>
        ...
        RelationalTypeMapping? typeMapping = null)
    {
        ...
        switch (operatorType)
        {
            case GaussDBExpressionType.Contains:
            case GaussDBExpressionType.ContainedBy:
            case GaussDBExpressionType.Overlaps:
            case GaussDBExpressionType.NetworkContainedByOrEqual:
            case GaussDBExpressionType.NetworkContainsOrEqual:
            case GaussDBExpressionType.NetworkContainsOrContainedBy:
            case GaussDBExpressionType.RangeIsStrictlyLeftOf:
            case GaussDBExpressionType.RangeIsStrictlyRightOf:
            case GaussDBExpressionType.RangeDoesNotExtendRightOf:
            case GaussDBExpressionType.RangeDoesNotExtendLeftOf:
            case GaussDBExpressionType.RangeIsAdjacentTo:
            case GaussDBExpressionType.TextSearchMatch:
            case GaussDBExpressionType.JsonExists:
            case GaussDBExpressionType.JsonExistsAny:
            case GaussDBExpressionType.JsonExistsAll:
        ...
        return (GaussDBBinaryExpression)ApplyTypeMapping(
            new GaussDBBinaryExpression(operatorType, left, right, returnType, null), typeMapping);
    }

    /// <summary>
    ///     Creates a new <see cref="GaussDBBinaryExpression" />, for checking whether one value contains another.
    /// </summary>
    public virtual SqlExpression Contains(SqlExpression left, SqlExpression right)
    {
        ...
        return MakePostgresBinary(GaussDBExpressionType.Contains, left, right);
    }

    /// <summary>
    ///     Creates a new <see cref="GaussDBBinaryExpression" />, for checking whether one value is contained by another.
    /// </summary>
    public virtual SqlExpression ContainedBy(SqlExpression left, SqlExpression right)
    {
        ...
        return MakePostgresBinary(GaussDBExpressionType.ContainedBy, left, right);
    }

    /// <summary>
    ///     Creates a new <see cref="GaussDBBinaryExpression" />, for checking whether one value overlaps with another.
    /// </summary>
    public virtual SqlExpression Overlaps(SqlExpression left, SqlExpression right)
    {
        ...
        return MakePostgresBinary(GaussDBExpressionType.Overlaps, left, right);
    }

    /// <summary>
    ///     Creates a new <see cref="GaussDBFunctionExpression" /> for a GaussDB aggregate function call..
    /// </summary>
    public virtual GaussDBFunctionExpression AggregateFunction(
        string name,
        ...
        RelationalTypeMapping? typeMapping = null)
    {
        ...
        return new GaussDBFunctionExpression(
            name,
            typeMappedArguments,
            argumentNames: null,
    ...
    public override SqlExpression? ApplyTypeMapping(SqlExpression? sqlExpression, RelationalTypeMapping? typeMapping)
    {
        if (sqlExpression is not null && sqlExpression.TypeMapping is null)
        {
            sqlExpression = sqlExpression switch
            {
                ...
                GaussDBAnyExpression e => ApplyTypeMappingOnAny(e),
                GaussDBAllExpression e => ApplyTypeMappingOnAll(e),
                GaussDBArrayIndexExpression e => ApplyTypeMappingOnArrayIndex(e, typeMapping),
                GaussDBArraySliceExpression e => ApplyTypeMappingOnArraySlice(e, typeMapping),
                GaussDBBinaryExpression e => ApplyTypeMappingOnPostgresBinary(e, typeMapping),
                GaussDBFunctionExpression e => e.ApplyTypeMapping(typeMapping),
                GaussDBILikeExpression e => ApplyTypeMappingOnILike(e),
                GaussDBNewArrayExpression e => ApplyTypeMappingOnNewArray(e, typeMapping),
                GaussDBRegexMatchExpression e => ApplyTypeMappingOnRegexMatch(e),
                GaussDBRowValueExpression e => ApplyTypeMappingOnRowValue(e, typeMapping),
    ...
    private SqlBinaryExpression ApplyTypeMappingOnSqlBinary(SqlBinaryExpression binary, RelationalTypeMapping? typeMapping)
    {
            ...
            && TryGetRowValueValues(binary.Right, out var rightValues))
        {
            ...
            binary = new SqlBinaryExpression(
                binary.OperatorType,
                new GaussDBRowValueExpression(updatedLeftValues, binary.Left.Type),
                new GaussDBRowValueExpression(updatedRightValues, binary.Right.Type),
                binary.Type,
                binary.TypeMapping);
        }
        ...
        bool TryGetRowValueValues(SqlExpression e, [NotNullWhen(true)] out IReadOnlyList<SqlExpression>? values)
        {
            switch (e)
            {
                case GaussDBRowValueExpression rowValueExpression:
    ...
    private SqlExpression ApplyTypeMappingOnRegexMatch(GaussDBRegexMatchExpression pgRegexMatchExpression)
    {
        ...
        return new GaussDBRegexMatchExpression(
    ...
    private SqlExpression ApplyTypeMappingOnRowValue(
        GaussDBRowValueExpression pgRowValueExpression,
        RelationalTypeMapping? typeMapping)
    {
        ...
        return new GaussDBRowValueExpression(updatedValues, pgRowValueExpression.Type, typeMapping);
    }

    private SqlExpression ApplyTypeMappingOnAny(GaussDBAnyExpression pgAnyExpression)
    {
        var (item, array) = ApplyTypeMappingsOnItemAndArray(pgAnyExpression.Item, pgAnyExpression.Array);
        return new GaussDBAnyExpression(item, array, pgAnyExpression.OperatorType, _boolTypeMapping);
    }

    private SqlExpression ApplyTypeMappingOnAll(GaussDBAllExpression pgAllExpression)
    {
        var (item, array) = ApplyTypeMappingsOnItemAndArray(pgAllExpression.Item, pgAllExpression.Array);
        return new GaussDBAllExpression(item, array, pgAllExpression.OperatorType, _boolTypeMapping);
    }
    ...
    private SqlExpression ApplyTypeMappingOnArrayIndex(
        GaussDBArrayIndexExpression pgArrayIndexExpression,
        RelationalTypeMapping? typeMapping)
    {
        ...
        return new GaussDBArrayIndexExpression(
            array,
    ...
    private SqlExpression ApplyTypeMappingOnArraySlice(
        GaussDBArraySliceExpression slice,
        RelationalTypeMapping? typeMapping)
    {
        ...
        return new GaussDBArraySliceExpression(
            array,
    ...
    private SqlExpression ApplyTypeMappingOnILike(GaussDBILikeExpression ilikeExpression)
    {
        ...
        return new GaussDBILikeExpression(
    ...
    private SqlExpression ApplyTypeMappingOnPostgresBinary(
        GaussDBBinaryExpression pgBinaryExpression,
        RelationalTypeMapping? typeMapping)
    {
        ...
        switch (operatorType)
        {
            ...
            case GaussDBExpressionType.RangeIsAdjacentTo:
            {
                ...
                if (operatorType == GaussDBExpressionType.ContainedBy)
                {
                ...
                return new GaussDBBinaryExpression(operatorType, newLeft, newRight, resultType, resultTypeMapping);
            }
            ...
            case GaussDBExpressionType.JsonExistsAll:
            {
                ...
                return new GaussDBBinaryExpression(
                    operatorType,
                    ApplyDefaultTypeMapping(left),
            ...
            case GaussDBExpressionType.RangeUnion:
            case GaussDBExpressionType.RangeIntersect:
            case GaussDBExpressionType.RangeExcept:
            case GaussDBExpressionType.TextSearchAnd:
            case GaussDBExpressionType.TextSearchOr:
            {
    ...
    private SqlExpression ApplyTypeMappingOnNewArray(
        GaussDBNewArrayExpression pgNewArrayExpression,
        RelationalTypeMapping? typeMapping)
    {
        ...
        return new GaussDBNewArrayExpression(
