...
/// </summary>
public class GaussDBFunctionExpression : SqlFunctionExpression, IEquatable<GaussDBFunctionExpression>
{
    /// <inheritdoc />
    ...
    /// <summary>
    ///     Creates an instance of <see cref="GaussDBFunctionExpression" /> with named arguments.
    /// </summary>
    public static GaussDBFunctionExpression CreateWithNamedArguments(
        string name,
    ...
    /// <summary>
    ///     Creates an instance of <see cref="GaussDBFunctionExpression" /> with argument separators.
    /// </summary>
    public static GaussDBFunctionExpression CreateWithArgumentSeparators(
        string name,
        IEnumerable<SqlExpression> arguments,
    ...
    /// <summary>
    ///     Creates a new instance of <see cref="GaussDBFunctionExpression" />.
    /// </summary>
    public GaussDBFunctionExpression(
        string name,
        IEnumerable<SqlExpression> arguments,
        IEnumerable<string?>? argumentNames,
        IEnumerable<string?>? argumentSeparators,
    ...
    /// </summary>
    public virtual GaussDBFunctionExpression UpdateAggregateComponents(
    ...
    public override bool Equals(object? obj)
        => obj is GaussDBFunctionExpression pgFunction && Equals(pgFunction);

    /// <inheritdoc />
    public virtual bool Equals(GaussDBFunctionExpression? other)
