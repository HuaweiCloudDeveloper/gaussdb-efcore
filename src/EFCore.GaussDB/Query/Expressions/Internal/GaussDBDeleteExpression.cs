...
/// </summary>
public sealed class GaussDBDeleteExpression : Expression, IPrintableExpression
{
    /// <summary>
    ...
    /// <summary>
    ///     Creates a new instance of the <see cref="GaussDBDeleteExpression" /> class.
    /// </summary>
    public GaussDBDeleteExpression(
    ...
    public GaussDBDeleteExpression Update(SqlExpression? predicate)
        => predicate == Predicate
            ? this
            : new GaussDBDeleteExpression(Table, FromItems, predicate, Tags);
    ...
    public override bool Equals(object? obj)
        => obj != null
            && (ReferenceEquals(this, obj)
                || obj is GaussDBDeleteExpression pgDeleteExpression
                && Equals(pgDeleteExpression));

    private bool Equals(GaussDBDeleteExpression pgDeleteExpression)
