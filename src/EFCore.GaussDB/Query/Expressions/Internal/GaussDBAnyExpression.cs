...
/// </remarks>
public class GaussDBAnyExpression : SqlExpression, IEquatable<GaussDBAnyExpression>
{
    ...
    /// <summary>
    ///     Constructs a <see cref="GaussDBAnyExpression" />.
    /// </summary>
    ...
    public virtual GaussDBAnyExpression Update(SqlExpression item, SqlExpression array)
        => item != Item || array != Array
            ? new GaussDBAnyExpression(item, array, OperatorType, TypeMapping)
            : this;

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(GaussDBAnyExpression).GetConstructor(
    ...
    public override bool Equals(object? obj)
        => obj is GaussDBAnyExpression e && Equals(e);

    /// <inheritdoc />
    public virtual bool Equals(GaussDBAnyExpression? other)
...
/// <summary>
///     Determines the operator type for a <see cref="GaussDBAnyExpression" />.
/// </summary>
