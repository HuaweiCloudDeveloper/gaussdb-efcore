...
/// </remarks>
public class GaussDBAllExpression : SqlExpression, IEquatable<GaussDBAllExpression>
{
    ...
    /// <summary>
    ///     Constructs a <see cref="GaussDBAllExpression" />.
    /// </summary>
    ...
    public virtual GaussDBAllExpression Update(SqlExpression item, SqlExpression array)
        => item != Item || array != Array
            ? new GaussDBAllExpression(item, array, OperatorType, TypeMapping)
            : this;

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(GaussDBAllExpression).GetConstructor(
    ...
    public override bool Equals(object? obj)
        => obj is GaussDBAllExpression e && Equals(e);

    /// <inheritdoc />
    public virtual bool Equals(GaussDBAllExpression? other)
...
/// <summary>
///     Determines the operator type for a <see cref="GaussDBAllExpression" />.
/// </summary>
