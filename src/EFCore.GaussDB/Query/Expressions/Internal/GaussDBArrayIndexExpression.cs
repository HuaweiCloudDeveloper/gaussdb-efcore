...
/// </remarks>
public class GaussDBArrayIndexExpression : SqlExpression, IEquatable<GaussDBArrayIndexExpression>
{
    ...
    /// <summary>
    ///     Creates a new instance of the <see cref="GaussDBArrayIndexExpression" /> class.
    /// </summary>
    ...
    public GaussDBArrayIndexExpression(
        SqlExpression array,
        SqlExpression index,
        bool nullable,
        Type type,
    ...
    public virtual GaussDBArrayIndexExpression Update(SqlExpression array, SqlExpression index)
        => array == Array && index == Index
            ? this
            : new GaussDBArrayIndexExpression(array, index, IsNullable, Type, TypeMapping);

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(GaussDBArrayIndexExpression).GetConstructor(
    ...
    /// <inheritdoc />
    public virtual bool Equals(GaussDBArrayIndexExpression? other)
    ...
    public override bool Equals(object? obj)
        => obj is GaussDBArrayIndexExpression e && Equals(e);
