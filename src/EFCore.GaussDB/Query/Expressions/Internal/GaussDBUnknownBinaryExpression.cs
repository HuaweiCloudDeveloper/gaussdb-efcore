...
///     no inference logic for it in <see cref="GaussDBExpressionFactory" />.
/// </summary>
public class GaussDBUnknownBinaryExpression : SqlExpression, IEquatable<GaussDBUnknownBinaryExpression>
{
    ...
    /// <summary>
    ///     Constructs a <see cref="GaussDBUnknownBinaryExpression" />.
    /// </summary>
    ...
    public GaussDBUnknownBinaryExpression(
        SqlExpression left,
        SqlExpression right,
    ...
    /// </summary>
    public virtual GaussDBUnknownBinaryExpression Update(SqlExpression left, SqlExpression right)
        => left == Left && right == Right
            ? this
            : new GaussDBUnknownBinaryExpression(left, right, Operator, Type, TypeMapping);

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(GaussDBUnknownBinaryExpression).GetConstructor(
    ...
    /// <inheritdoc />
    public virtual bool Equals(GaussDBUnknownBinaryExpression? other)
        => ReferenceEquals(this, other)
            || other is not null && Left.Equals(other.Left) && Right.Equals(other.Right) && Operator == other.Operator;

    /// <inheritdoc />
    public override bool Equals(object? obj)
        => obj is GaussDBUnknownBinaryExpression e && Equals(e);
