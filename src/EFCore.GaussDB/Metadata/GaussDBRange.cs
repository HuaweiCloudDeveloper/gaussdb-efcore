...
public class GaussDBRange
{
    ...
    /// </exception>
    internal GaussDBRange(IReadOnlyAnnotatable annotatable, string annotationName)
    {
    ...
    /// <summary>
    ///     Gets or adds a <see cref="GaussDBRange" /> from or to the <see cref="IMutableAnnotatable" />.
    /// </summary>
    ...
    /// <returns>
    ///     The <see cref="GaussDBRange" /> from the <see cref="IMutableAnnotatable" />.
    /// </returns>
    ...
    /// </exception>
    public static GaussDBRange GetOrAddPostgresRange(
        ...
        string? subtypeDiff = null)
    {
        ...
        return new GaussDBRange(annotatable, annotationName)
        {
            Subtype = subtype,
    ...
    /// <summary>
    ///     Finds a <see cref="GaussDBRange" /> in the <see cref="IAnnotatable" />, or returns null if not found.
    /// </summary>
    /// <param name="annotatable">The annotatable to search for the range.</param>
    /// <param name="schema">The range schema or null to use the model's default schema.</param>
    /// <param name="name">The range name.</param>
    /// <returns>
    ///     The <see cref="GaussDBRange" /> from the <see cref="IAnnotatable" />.
    /// </returns>
    /// <exception cref="ArgumentException">
    ///     <paramref name="schema" />
    /// </exception>
    ...
    ///     <paramref name="name" />
    /// </exception>
    public static GaussDBRange? FindPostgresRange(
        ...
        string name)
    {
        ...
        return annotatable[annotationName] is null ? null : new GaussDBRange(annotatable, annotationName);
    }
    ...
    /// <summary>
    ///     Gets the collection of <see cref="GaussDBRange" /> stored in the <see cref="IAnnotatable" />.
    /// </summary>
    /// <param name="annotatable">The annotatable to search for <see cref="GaussDBRange" /> annotations.</param>
    /// <returns>
    ///     The collection of <see cref="GaussDBRange" /> stored in the <see cref="IAnnotatable" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="annotatable" />
    /// </exception>
    public static IEnumerable<GaussDBRange> GetPostgresRanges(IReadOnlyAnnotatable annotatable)
        => Check.NotNull(annotatable, nameof(annotatable))
            .GetAnnotations()
            .Where(a => a.Name.StartsWith(GaussDBAnnotationNames.RangePrefix, StringComparison.Ordinal))
            .Select(a => new GaussDBRange(annotatable, a.Name));
