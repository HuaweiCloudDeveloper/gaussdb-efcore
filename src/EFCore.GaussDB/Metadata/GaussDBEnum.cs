...
public class GaussDBEnum
{
    ...
    /// </exception>
    internal GaussDBEnum(IReadOnlyAnnotatable annotatable, string annotationName)
    {
    ...
    /// <summary>
    ///     Gets or adds a <see cref="GaussDBEnum" /> from or to the <see cref="IMutableAnnotatable" />.
    /// </summary>
    ...
    /// <returns>
    ///     The <see cref="GaussDBEnum" /> from the <see cref="IMutableAnnotatable" />.
    /// </returns>
    ...
    /// </exception>
    public static GaussDBEnum GetOrAddPostgresEnum(
        ...
        string[] labels)
    {
        ...
        return new GaussDBEnum(annotatable, annotationName) { Labels = labels };
    }
    ...
    /// <summary>
    ///     Finds a <see cref="GaussDBEnum" /> in the <see cref="IAnnotatable" />, or returns null if not found.
    /// </summary>
    /// <param name="annotatable">The annotatable to search for the enum.</param>
    /// <param name="schema">The enum schema or null to use the model's default schema.</param>
    /// <param name="name">The enum name.</param>
    /// <returns>
    ///     The <see cref="GaussDBEnum" /> from the <see cref="IAnnotatable" />.
    /// </returns>
    /// <exception cref="ArgumentException">
    ///     <paramref name="schema" />
    /// </exception>
    ...
    ///     <paramref name="name" />
    /// </exception>
    public static GaussDBEnum? FindPostgresEnum(
        ...
        string name)
    {
        ...
        return annotatable[annotationName] is null ? null : new GaussDBEnum(annotatable, annotationName);
    }
    ...
    /// <summary>
    ///     Gets the collection of <see cref="GaussDBEnum" /> stored in the <see cref="IAnnotatable" />.
    /// </summary>
    /// <param name="annotatable">The annotatable to search for <see cref="GaussDBEnum" /> annotations.</param>
    /// <returns>
    ///     The collection of <see cref="GaussDBEnum" /> stored in the <see cref="IAnnotatable" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="annotatable" />
    /// </exception>
    public static IEnumerable<GaussDBEnum> GetPostgresEnums(IReadOnlyAnnotatable annotatable)
        => Check.NotNull(annotatable, nameof(annotatable))
            .GetAnnotations()
            .Where(a => a.Name.StartsWith(GaussDBAnnotationNames.EnumPrefix, StringComparison.Ordinal))
            .Select(a => new GaussDBEnum(annotatable, a.Name));
