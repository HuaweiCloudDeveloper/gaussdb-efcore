...
/// </remarks>
public class GaussDBModelFinalizingConvention : IModelFinalizingConvention
{
    private readonly IRelationalTypeMappingSource _typeMappingSource;
    private readonly IReadOnlyList<EnumDefinition> _enumDefinitions;

    /// <summary>
    ///     Creates a new instance of <see cref="GaussDBModelFinalizingConvention" />.
    /// </summary>
    /// <param name="typeMappingSource">The type mapping source to use.</param>
    /// <param name="enumDefinitions"></param>
    public GaussDBModelFinalizingConvention(
