...
#pragma warning restore CS0618
    ...
    private sealed class ExtensionInfo(IDbContextOptionsExtension extension) : RelationalExtensionInfo(extension)
    {
        ...
        {
            debugInfo["HuaweiCloud.EntityFrameworkCore.GaussDB:" + nameof(GaussDBDbContextOptionsBuilder.UseAdminDatabase)]
                = (Extension.AdminDatabase?.GetHashCode() ?? 0).ToString(CultureInfo.InvariantCulture);

            debugInfo["HuaweiCloud.EntityFrameworkCore.GaussDB:" + nameof(GaussDBDbContextOptionsBuilder.SetPostgresVersion)]
                = Extension.PostgresVersion.GetHashCode().ToString(CultureInfo.InvariantCulture);

            debugInfo["HuaweiCloud.EntityFrameworkCore.GaussDB:" + nameof(GaussDBDbContextOptionsBuilder.UseRedshift)]
            ...
            debugInfo["HuaweiCloud.EntityFrameworkCore.GaussDB:" + nameof(GaussDBDbContextOptionsBuilder.RemoteCertificateValidationCallback)]
            ...
            debugInfo["HuaweiCloud.EntityFrameworkCore.GaussDB:" + nameof(GaussDBDbContextOptionsBuilder.ProvidePasswordCallback)]
